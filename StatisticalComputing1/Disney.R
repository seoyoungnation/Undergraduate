...
displus <- "https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EB%94%94%EC%A6%88%EB%8B%88%ED%94%8C%EB%9F%AC%EC%8A%A4&sort=0&photo=0&field=0&pd=3&ds=2019.01.31&de=2021.11.30&cluster_rank=27&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so:r,p:from20190131to20211130,a:all&start="
urls <- NULL
for ( x in 0 : 39){
  urls <- c(urls, paste(displus,x*10+1,sep=''))
}
