...
wavve <- "https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EC%9B%A8%EC%9D%B4%EB%B8%8C%20OTT&sort=0&photo=0&field=0&pd=3&ds=2019.01.31&de=2021.11.30&cluster_rank=21&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so:r,p:from20190131to20211130,a:all&start="
urls <- NULL
for ( x in 0 : 39){
  urls <- c(urls, paste(wavve,x*10+1,sep=''))
}
