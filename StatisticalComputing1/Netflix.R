...
u1 <- "https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EB%84%B7%ED%94%8C%EB%A6%AD%EC%8A%A4&ds=2019.01.31&de=2021.11.30&start="
urls <- NULL
for ( x in 0 : 39){
  urls <- c(urls, paste(u1,x*10+1,sep=''))
}
